...
const Footer = () => {
    return (
        <div>
            <div className='p-12 bg-gray-100 grid grid-cols-1 md:grid-cols-2 justify-between gap-5'>
            ...
            <div className=' text-center'>
                ...
                <div className='flex items-center gap-5 w-96 text-center  mx-auto'>
                    <Input placeholder='Enter Your Email.' />
                    <Button>Subscribed</Button>
                </div>
                <div className='flex gap-5 items-center justify-start w-96 mx-auto pt-5'>
